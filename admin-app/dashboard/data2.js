  ...
  "dedup": {
    ...
    "cleared": [
      ...
      },
      {
        ...
        "reason": "동일 교육과정의 세 번째 대상학교 순회 운영(덕암→진경→남원) — 반복 아닌 확산. 4영역 전수 대조: 기존 카드(타교·참여자 비중복)·지출(금액·산출구조 상이, 이중청구 없음)·타 사업단(해당 없음)·타 재정사업(로고·예산 혼재 없음) 이상 없음. 단, 보고서 내 청구서 제목 \"(진경여자고)\" 오기 등 정정 필요 사항 발견. ※ 분석 당일 사용자 요청으로 실적 반영 철회 — 보고서 정정 후 재제출·재분석 예정 (판정 이력은 보존)"
      }
    ],
    "linked": [
      {
