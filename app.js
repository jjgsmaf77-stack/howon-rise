...
(() => {
  ...
  function showGate() {
    ...
    style.textContent = `
      #pw-gate{position:fixed;inset:0;z-index:9999;display:flex;align-items:flex-start;justify-content:center;
        background:#f4f7fb;padding:9vh 16px 0;font-family:'KoPubWorldDotum','Noto Sans KR',sans-serif}
      #pw-gate .box{width:100%;max-width:360px;background:#fff;border:1px solid #e8edf2;border-radius:14px;
