...
window.__RISE2__ = {
  "generatedAt": "2026-09-06T03:29:11.280Z",
  "year": 2026,
  "yearLabel": "2차년도(2026)",
  ...
  "divisions": [
    ...
    },
    {
      ...
      "programs": [
        {
          "file": "2026-05 COOKING브릿지-조리경연대회 교육(남원제일고)",
          "name": "COOKING브릿지-조리경연대회 교육(남원제일고)",
          "category": "경연대회지도",
          "org": "남원제일고등학교",
          ...
          "extra": "전국규모 조리경연대회 4팀 16명 전원 수상 — 금메달 2팀·은메달 2팀, 특별상 2종(대상 전북특별자치도교육감상·장려상 한국조리협회장상)",
          "status": "추출완료",
          "approval": "결과보고서 제출 2026.08.18 (결재번호 미기재 🔴)"
        },
        {
      ...
      "spending": [
        ...
        {
          "date": "2026-08-18",
          "name": "COOKING브릿지(남원제일고) 강사료·재료비",
          "item": "교육·연구 프로그램 운영·개발",
          "tanker": "T",
          "execType": "자체운영",
          "fund": "본예산",
          "amount": 5447200,
          "doc": "결과보고서 지출내역 p.3 (결재번호 미기재 🔴)",
          "verified": false
        }
      ],
      "students": 97,
  ...
  "dedup": {
    ...
    "cleared": [
      {
        "date": "2026-07-26",
        "content": "COOKING브릿지-조리경연대회 교육: 덕암정보고(5~6월)·진경여고(6~7월)",
        "reason": "동일 교육과정의 대상학교별 순회 운영 — 반복이 아닌 확산. 연차보고서에 \"조리경연대회 교육 2건\"으로 집계"
      },
      {
        "date": "2026-07-26",
        "content": "강의자료 2종이 덕암·진경여고 폴더에 각각 존재",
        "reason": "공용 교재의 프로그램별 증빙 사본 — 정상 (분석은 1회만)"
      },
      {
        "date": "2026-07-26",
        "content": "아이들 웃음도 JobGO (맛잡고×성인)",
        "reason": "연계 프로그램 — 장려 실적. 02_연계 프로그램 대장 #1로 이관"
      },
      {
        "date": "2026-09-06",
        "content": "COOKING브릿지-조리경연대회 교육(남원제일고, 5월)",
        "reason": "동일 교육과정의 세 번째 대상학교 순회 운영(덕암→진경→남원) — 반복 아닌 확산. 4영역 전수 대조: 기존 카드(타교·참여자 비중복)·지출(금액·산출구조 상이, 이중청구 없음)·타 사업단(해당 없음)·타 재정사업(로고·예산 혼재 없음) 이상 없음. 단, 보고서 내 청구서 제목 \"(진경여자고)\" 오기 발견 — 카드 🔴 #4에 정정 필요로 기록"
      }
    ],
    "linked": [
      {
        "date": "2026-05-03",
        "name": "아이들 웃음도 JobGO! 배움도 JobGO!",
        "divisions": "맛잡고 × 성인(=H-성인학습지원사업단, 동일체)",
        "record": "양측 각 1건 (참여 17명·만족도 4.92)",
        "budget": "맛잡고 935,380원"
      }
    ],
    "projects": [
      {
        ...
        "dept": "앵커(RISE)사업단",
        "status": "수행 중",
        "note": "본 플랫폼 관리 대상 (9개 단위과제 간 연계·중복 상시 점검)"
      },
      {
        "name": "대학혁신지원사업",
        "sponsor": "교육부",
        "dept": "🔴 담당 부서 확인 필요",
        "status": "수행 중",
        "note": "교육 프로그램 성격이 가장 유사 — 참여자만 변경한 유사 프로그램 불허, 예산 혼합 금지"
      },
      {
        "name": "BI(창업보육센터) 육성사업",
        "sponsor": "중소벤처기업부",
